...
If you want to learn more about SCPI/VISA check out our repository here with some basic examples that utilize the PyVisa library [here](https://github.com/wrongbaud/conduit) We've put together a wrapper for basic oscilloscope control and power supply control, see the repository for more details!
